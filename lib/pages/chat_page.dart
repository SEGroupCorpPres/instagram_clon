...
import 'package:flutter_icons/flutter_icons.dart' show Feather, FontAwesome;
                          ...
                          Container(
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  image: NetworkImage(chats[index]['profile'].toString()),
                                  fit: BoxFit.cover
                              ),
                            ),
                          ),
  ...
  Widget getRooms(size){
    return Center(
      child: Padding(
        ...
        child: Column(
          children: [
            SvgPicture.asset('assets/svg/video.svg', width: 100,),
            SizedBox(height: 20,),
            Text(
            ...
            SizedBox(height: 15,),
            Text(
              'Invite up to 50 people to join a video chat, even if they don\'t have Instagram Messsage',
